...
export const INITIAL_TEACHER_ADMIN_DOCS: TeacherAdministrationDoc[] = [
  {
    ...
    title: 'Modul Ajar Bab 1: Keanekaragaman Hayati & Konservasi Flora-Fauna Flores',
    description: 'Perangkat ajar lengkap memuat Tujuan Pembelajaran, Pemahaman Bermakna, Pertanyaan Pemantik, Alur Kegiatan 4 Pertemuan, dan Lembar Kerja Siswa (LKS) Berbasis Riset Lokal.',
    fileUrl: '#download-modul-biologi-fase-e',
    fileName: 'Modul_Ajar_Biologi_FaseE_Bab1_Theresia.pdf',
    fileSize: '4.8 MB',
    fileType: 'PDF',
    ...
    feedbackNotes: 'Perangkat sangat komprehensif. Integrasi kearifan lokal konservasi hutan Ranamese dan Wae Rebo sangat relevan dengan Profil Pelajar Pancasila.',
    supervisionScore: 96,
  },
  {
    id: 'adm-002',
    ...
    title: 'Program Tahunan (Prota) Biologi Fase E Tahun Pelajaran 2026/2027',
    description: 'Pemetaan alokasi waktu tahunan (72 JP) meliputi capaian pembelajaran ekosistem, bioteknologi konvensional, dan proyek konservasi lingkungan.',
    fileUrl: '#download-prota-biologi',
    fileName: 'PROTA_Biologi_2026_2027_SMAKSetiaBakti.docx',
    fileSize: '1.2 MB',
    fileType: 'DOCX',
    uploadedAt: '10 Agustus 2026',
    status: 'Disetujui',
    verifiedBy: 'Drs. Petrus Kanisius Dadi (Kepala Sekolah)',
    verifiedAt: '14 Agustus 2026',
    feedbackNotes: 'Alokasi waktu efektif telah disesuaikan dengan kalender akademik Keuskupan dan Dinas Pendidikan.',
    supervisionScore: 94,
  },
  {
    id: 'adm-003',
    ...
    subject: 'Sosiologi & Antropologi Budaya',
    targetClass: 'Fase F (Kelas XI & XII IPS)',
    academicYear: '2026/2027',
    semester: 'Ganjil',
    category: 'Alur Tujuan Pembelajaran (ATP)',
    title: 'ATP Sosiologi Fase F: Transformasi Sosial Masyarakat Manggarai Modern',
    description: 'Penjabaran elemen pemahaman sosiologis dan keterampilan proses riset etnografi sosial.',
    fileUrl: '#download-atp-sosiologi',
    fileName: 'ATP_Sosiologi_FaseF_Kornelis_Hambur.pdf',
    fileSize: '2.5 MB',
    fileType: 'PDF',
